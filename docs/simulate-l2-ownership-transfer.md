...
4. Using the data in the `TransactionDeposited` event, create a new Tenderly simulation by opening the [Simulator](https://dashboard.tenderly.co/TENDERLY_USERNAME/TENDERLY_PROJECT/simulator/new) and filling in the form using the fields below. Set `from` to `0x0000000000000000000000000000000000000000`, `gas` to `8000000`, `gas price` and `value` to `0`.
