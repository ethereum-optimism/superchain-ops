...
import {IDeputyGuardianModule, IOptimismPortal2} from "lib/optimism/packages/contracts-bedrock/interfaces/safe/IDeputyGuardianModule.sol";
...
contract UnpauseSuperchainConfig is L2TaskBase {
    ...
    function _build(address) internal override {
        ...
        IDeputyGuardianModule dgm = IDeputyGuardianModule(
            superchainAddrRegistry.get("DeputyGuardianModule")
        );
