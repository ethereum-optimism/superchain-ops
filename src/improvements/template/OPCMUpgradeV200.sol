...
contract OPCMUpgradeV200 is OPCMBaseTask {
    ...
    function _validate(VmSafe.AccountAccess[] memory, Action[] memory) internal view override {
        ...
        for (uint256 i = 0; i < chains.length; i++) {
            ...
            string memory expectedErrors_420110004 = "PDDG-50,PDDG-DWETH-40,PDDG-ANCHORP-40,PDDG-120,PLDG-10";
            string memory expectedErrors_420110005 =
                "PDDG-50,PDDG-DWETH-40,PDDG-ANCHORP-40,PDDG-120,PLDG-50,PLDG-DWETH-40,PLDG-ANCHORP-40";
            require(
                reasons.eq(expectedErrors_11155420) || reasons.eq(expectedErrors_1946)
                    || reasons.eq(expectedErrors_763373) || reasons.eq(expectedErrors_420110004)
                    || reasons.eq(expectedErrors_420110005),
