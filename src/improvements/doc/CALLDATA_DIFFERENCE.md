...
command:
```bash
forge script test/tasks/mock/example/template/GasConfigTemplate.sol --sig "run(string)" test/tasks/mock/example/task-03/mainnetConfig.toml --rpc-url mainnet -vvv
```
