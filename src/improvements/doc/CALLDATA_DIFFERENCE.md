...
command:
```bash
forge script src/improvements/template/GasConfigTemplate.sol --sig "simulateRun(string,bytes)" test/tasks/mock/configs/OPMainnetGasConfigTemplate.toml 0x --rpc-url mainnet -vvv
```
