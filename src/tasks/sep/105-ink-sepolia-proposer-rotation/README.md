...
Status: DRAFT, NOT READY TO SIGN — simulates successfully against live (pre-U19) state; the proposer-only `gameArgs(1)` diff is confirmed (old Gelato proposer fully replaced, challenger/prestate preserved). **MUST be re-simulated after U19 (2026-06-17)** before signing, since U19 may bump the prestate embedded in `gameArgs(1)` — the nested signer message hashes in [VALIDATION.md](./VALIDATION.md) are generated then via the nested signing flow.
...
| Field | Bytes | Current (on-chain, pre-U19) | New |
|-------|-------|------------------------------|-----|
| prestate | 0–32 | `0x033c000916b4a88cfffeceddd6cf0f4be3897a89195941e5a7c3f8209b4dbb6e` | unchanged (read live; U19 may bump) |
| vm | 32–52 | `0x6463dee3828677f6270d83d45408044fc5edb908` | unchanged |
| anchorStateRegistry | 52–72 | `0x299d7ea9f0b584cfaf2a5341d151b44967594ca9` | unchanged |
| delayedWETH | 72–92 | `0x52d5bdc07f4ac131c21f09ffda1440f0152a8ac6` | unchanged |
...
`gameImpls(1)` is unchanged at `0x58bf355C5d4EdFc723eF89d99582ECCfd143266A`; `initBonds(1)` stays `0.08 ETH`. Game types 0 (CANNON) and 8 (CANNON_KONA) are untouched.
