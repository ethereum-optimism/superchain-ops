# 063-rev-share-ink-soneium: RevShare Upgrade and Setup for Ink Sepolia and Soneium Minato
...
just simulate-stack sep 063-rev-share-ink-soneium <council|foundation>

# For individual simulation:
cd src/tasks/sep/063-rev-share-ink-soneium
