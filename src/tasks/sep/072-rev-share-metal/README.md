...
Upgrade proxies and setup RevShare contracts for Metal L2 Testnet. This task:
...
2. Upgrades the fee vault proxy implementations (SequencerFeeVault, BaseFeeVault, L1FeeVault, OperatorFeeVault) on Metal L2 Testnet L2
...
just simulate-stack sep 072-rev-share-metal <council|foundation>

# For individual simulation:
cd src/tasks/sep/072-rev-share-metal
