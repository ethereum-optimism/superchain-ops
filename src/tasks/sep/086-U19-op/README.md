...
Upgrades OP Sepolia Testnet (chainId `11155420`) to Upgrade 19 (`op-contracts/v7.1.17`)
...
This task is first in the U19 Sepolia sequence (`086` → `087` → `088` → `089`)
...
just simulate-stack sep 086-U19-op

# Sign
USE_KEYSTORE=1 just sign-stack sep 086-U19-op

# Execute
cd src/tasks/sep/086-U19-op
