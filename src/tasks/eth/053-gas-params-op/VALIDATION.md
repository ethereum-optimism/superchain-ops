...
>
> - Safe Transaction Hash: `0x8b4d2f64ef57d9fac1c25befa2ee8d43c2fe0e31d01c0be06b9860ba1d50810d`
> - Domain Hash: `0xa4a9c312badf3fcaa05eafe5dc9bee8bd9316c78ee8b0bebe3115bb21b732672`
> - Message Hash: `0xafc20fcbf418f4c9bb668c27db8784ce5b3f9ea7345baaf7b19bf7a433a69e9d`
...
We set the onchain gasLimit to 80M (previously 40M) so that the gasTarget doubles from 20Mgas/block to 40Mgas/block. This is the formula to calculate the gasTarget:
```
...
Note: these are the values already set onchain (denominator 250, elasticity 2), so this call does not change the EIP-1559 parameters. We must still provide these values because `setEIP1559Params` requires both, and the gasTarget increase is achieved entirely via the gasLimit change above.
...
Note: slot `0x6a` (eip1559Denominator / eip1559Elasticity) is **not** changed by this task. `setEIP1559Params(250, 2)` writes the values already present onchain (denominator 250, elasticity 2), so it produces no state diff on slot `0x6a`.
