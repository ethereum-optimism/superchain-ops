...
This replay was executed during task preparation: all three calls succeed within the 150k deposit
gas limit (~45.7k gas each, >3x headroom), produce exactly the expected end state with the
