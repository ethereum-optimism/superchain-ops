...
|---|---|---|
| `L1FeeVault` `0x420000000000000000000000000000000000001a` | v1.6.1 | recipient `0xa6f0F94C13C4255231958079E7331694205F6c93` → `0x1eB630b2e7409597D462dd5f3D21E305FC56B8C9`; minWithdrawalAmount **2 ETH → 0.15 ETH** (network already L1) |
| `OperatorFeeVault` `0x420000000000000000000000000000000000001b` | v1.1.1 | recipient `0x4200000000000000000000000000000000000019` (BaseFeeVault) → `0x1eB630b2e7409597D462dd5f3D21E305FC56B8C9`; withdrawalNetwork **L2 → L1**; minWithdrawalAmount **0 → 0.15 ETH** |
...
Per-field skip-unchanged yields exactly **5 deposits** (each with a 150,000 L2 gas limit):

1. `L1FeeVault.setRecipient(0x1eB630b2e7409597D462dd5f3D21E305FC56B8C9)`
2. `L1FeeVault.setMinWithdrawalAmount(150000000000000000)` (0.15 ETH)
...
5. `OperatorFeeVault.setMinWithdrawalAmount(150000000000000000)` (0.15 ETH)
...
After the five deposits are relayed on Ink Mainnet:
...
# → 150000000000000000 (0.15 ETH; was 2000000000000000000)
