...
> nonces pinned in [config.toml](./config.toml) (3-of-3 `11`, Chain Governor `20`, FUS `68`,
> SC `66` — each one ahead of task 069's pins, since 069 executes first; the pins apply whether
