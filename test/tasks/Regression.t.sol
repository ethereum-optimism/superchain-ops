...
contract RegressionTest is Test {
    ...
    function testRegressionCallDataMatches_TransferOwners() public {
        ...
        // Chain governor
        expectedDataToSign[0] =
            "0x19014f0b6efb6c01fa7e127a0ff87beefbeb53e056d30d3216c5ac70371b909ca66d279940ab2c692b1cf17afc08b3fedccaed9ba765091d1ac17ac89af8abdfc994";
        // Foundation
        expectedDataToSign[1] =
            "0x1901a4a9c312badf3fcaa05eafe5dc9bee8bd9316c78ee8b0bebe3115bb21b732672822f3773ac10b51293e877233b5b24a6d5d46cf16e660219a841f9d1ee6ec079";
        // Security council
        expectedDataToSign[2] =
            "0x1901df53d510b56e539b90b369ef08fce3631020fbf921e3136ea5f8747c20bce967bcd52ed3adf2900c70b59a5208329a2323d089f3e90b59ae9a7ef141b6ffba2f";
        _assertDataToSignNestedMultisig(multisigTask, actions, expectedDataToSign);
    }
