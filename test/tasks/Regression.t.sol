...
contract RegressionTest is Test {
    ...
    /// Simulate from task directory (test/tasks/example/sep/034-opcm-upgrade-v600/config.toml) with:
    /// SIMULATE_WITHOUT_LEDGER=1 just --dotenv-path "$(pwd)"/.env --justfile ../../../../../src/justfile simulate <council|foundation>
    function testRegressionCallDataMatches_OPCMUpgradeV600Template() public {
        string memory taskConfigFilePath = "test/tasks/example/sep/034-opcm-upgrade-v600/config.toml";
        string memory expectedCallData =
            "";
    ...
    /// Simulate from task directory (test/tasks/example/sep/033-opcm-upgrade-superchainconfig-v600/config.toml) with:
    /// SIMULATE_WITHOUT_LEDGER=1 just --dotenv-path "$(pwd)"/.env --justfile ../../../../../src/justfile simulate
    function testRegressionCallDataMatches_OPCMUpgradeSuperchainConfigV600Template() public {
        string memory taskConfigFilePath = "test/tasks/example/sep/033-opcm-upgrade-superchainconfig-v600/config.toml";
    ...
    /// @notice Expected call data and data to sign generated by manually running the RevShareUpgradeAndSetup template at block 9628956 on Sepolia.
    /// Simulate from task directory (test/tasks/example/sep/032-revshare-upgrade-and-setup) with:
    /// SIMULATE_WITHOUT_LEDGER=1 just --dotenv-path $(pwd)/.env --justfile ../../../../../src/improvements/single.just simulate <foundation|council>
    function testRegressionCallDataMatches_RevShareUpgradeAndSetupSepolia() public {
        string memory taskConfigFilePath = "test/tasks/example/sep/032-revshare-upgrade-and-setup/config.toml";
        string memory expectedCallData =
