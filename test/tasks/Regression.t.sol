...
contract RegressionTest is Test {
    ...
    function testRegressionCallDataMatches_SetDisputeGameImpl() public {
        ...
        string memory expectedCallData =
            "";
        MultisigTask multisigTask = new SetDisputeGameImpl();
        address foundationChildMultisig = 0xDEe57160aAfCF04c34C887B5962D0a69676d3C8B; // sepolia
        Action[] memory actions =
            _setupAndSimulateRun(taskConfigFilePath, 7798424, "sepolia", multisigTask, foundationChildMultisig);
        ...
        // Foundation
        expectedDataToSign[0] =
            "0x190137e1f5dd3b92a004a23589b741196c8a214629d4ea3a690ec8e41ae45c689cbb1dfbb9d48362b71daf4cd680678868c2c50a2c7fbc4d1870fb5f4793d636dbeb";
        // Security Council
        expectedDataToSign[1] =
            "0x1901be081970e9fc104bd1ea27e375cd21ec7bb1eec56bfe43347c3e36c5d27b8533c1c54e501d90b0489f87e86253e9da08cef48e605c42554e49b45f6c073e6657";
        _assertDataToSignNestedMultisig(multisigTask, actions, expectedDataToSign);
    }
