...
contract RegressionTest is Test {
    ...
    /// --sig "simulateRun(string)" test/tasks/example/sep/005-test-finance-operation/config.toml
    /// --rpc-url sepolia
    /// --fork-block-number 7985780
    /// -vv
    function testRegressionCallDataMatches_FinanceTemplate() public {
        string memory taskConfigFilePath = "test/tasks/example/sep/005-test-finance-operation/config.toml";
        // call data generated by manually running the FinanceTemplate at block 7985780 on sepolia
        string memory expectedCallData =
        ...
        MultisigTask.Action[] memory actions =
            _setupAndSimulateRun(taskConfigFilePath, 7985780, "sepolia", multisigTask, address(0));
