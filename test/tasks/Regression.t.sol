...
contract RegressionTest is Test {
    ...
    /// @notice Expected call data and data to sign generated by manually running the DisableModule template at block 8098229 on sepolia
    ...
    function testRegressionCallDataMatches_DisableModule() public {
        ...
        // Call data generated by manually running the DisableModule template at block 8098229 on sepolia.
        string memory expectedCallData =
        ...
        MultisigTask.Action[] memory actions = _setupAndSimulateRun(
            taskConfigFilePath, 8098229, "sepolia", multisigTask, 0xf64bc17485f0B4Ea5F06A96514182FC4cB561977
        );
