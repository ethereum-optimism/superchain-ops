...
import {OPCMUpgradeV200toV400} from "src/improvements/template/OPCMUpgradeV200toV400.sol";
...
contract RegressionTest is Test {
    ...
    /// @notice Expected call data and data to sign generated by manually running the SetDisputeGameImpl template at block 8826542 on sepolia.
    /// Simulate from task directory (test/tasks/example/sep/019-u13-to-u16/config.toml) with:
    /// SIMULATE_WITHOUT_LEDGER=1 just --dotenv-path $(pwd)/.env --justfile ../../../../../src/improvements/nested.just simulate <foundation|council>
    function testRegressionCallDataMatches_OPCMUpgradeV200toV400() public {
        string memory taskConfigFilePath = "test/tasks/example/sep/019-u13-to-u16/config.toml";
        string memory expectedCallData =
            "";
        MultisigTask multisigTask = new OPCMUpgradeV200toV400();
        address rootSafe = address(0x1Eb2fFc903729a0F03966B917003800b145F56E2);
        address nestedSafe = address(0xDEe57160aAfCF04c34C887B5962D0a69676d3C8B); // sepolia
        address[] memory allSafes = MultisigTaskTestHelper.getAllSafes(rootSafe, nestedSafe);
        (Action[] memory actions, uint256[] memory allOriginalNonces) =
            _setupAndSimulate(taskConfigFilePath, 8826542, "sepolia", multisigTask, allSafes);
