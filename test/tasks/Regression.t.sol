...
contract RegressionTest is Test {
    ...
    ///
    ///         TODO: run the simulation on a Sepolia fork, capture the printed calldata and data-to-sign,
    ///         then replace the placeholder strings below and remove the vm.skip() call.
    function testRegressionCallDataMatches_FeeVaultUpgradeTemplate() public {
        ...
        expectedDataToSign[0] = "0x"; // Foundation
        expectedDataToSign[1] = "0x"; // Security Council
