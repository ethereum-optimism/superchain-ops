...
contract RegressionTest is Test {
    ...
    /// Using script:
    /// forge script OPCMUpgradeV200 --sig "simulateRun(string)" src/improvements/tasks/example/sep/002-opcm-upgrade-v200/config.toml --rpc-url sepolia --fork-block-number 7826712 -vv
    function testRegressionCallDataMatches_OPCMUpgradeV200() public {
        string memory taskConfigFilePath = "src/improvements/tasks/example/sep/002-opcm-upgrade-v200/config.toml";
