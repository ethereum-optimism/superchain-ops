...
contract RegressionTest is Test {
    ...
    /// @notice Expected call data and data to sign generated by manually running the OPCMUpgradeV400 template at block 8318585 on sepolia.
    ...
    function testRegressionCallDataMatches_OPCMUpgradeV400() public {
        ...
        string memory expectedCallData =
            "";
        MultisigTask multisigTask = new OPCMUpgradeV400();
        address foundationChildMultisig = 0xDEe57160aAfCF04c34C887B5962D0a69676d3C8B; // sepolia
        MultisigTask.Action[] memory actions =
            _setupAndSimulateRun(taskConfigFilePath, 8318585, "sepolia", multisigTask, foundationChildMultisig);
        ...
        // Foundation data to sign
        expectedDataToSign[0] =
            "0x190137e1f5dd3b92a004a23589b741196c8a214629d4ea3a690ec8e41ae45c689cbb939d7f214b95cf6c935636057da1b9517bcd15ffc971356d42d5260cb79f8906";
        // Security council data to sign
        expectedDataToSign[1] =
            "0x1901be081970e9fc104bd1ea27e375cd21ec7bb1eec56bfe43347c3e36c5d27b8533cf4e16f2ccc2de527f789a4f7456328bbfb52085b2fbbde1a3acf47a2d97d88c";
    ...
    function testRegressionCallDataMatches_DisableModule() public {
        ...
        MultisigTask.Action[] memory actions = _setupAndSimulateRun(
