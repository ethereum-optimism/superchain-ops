...
/// @notice Expected call data and data to sign generated by manually running the TransferOwners template at block 8542367 on sepolia.
    ...
    function testRegressionCallDataMatches_SetDisputeGameImpl() public {
        ...
        Action[] memory actions =
            _setupAndSimulateRun(taskConfigFilePath, 8542367, "sepolia", multisigTask, address(0));
