...
contract RegressionTest is Test {
    ...
    function testRegressionCallDataMatches_FinanceTemplate() public {
        ...
        // call data generated by manually running the FinanceTemplate at block 7895691 on sepolia
        string memory expectedCallData =
        ...
        MultisigTask.Action[] memory actions =
            _setupAndSimulateRun(taskConfigFilePath, 7895691, "sepolia", multisigTask, address(0));

        _assertCallData(multisigTask, actions, expectedCallData);

        // data to sign generated by manually running the FinanceTemplate at block 7880546 on sepolia
        string memory expectedDataToSign =
            "0x190196c653b6193d04eb71ad87ac1577524661acf1e1e0c492a68c88a1deb059927f78c81a2cac2a58e7513cfc1f1565a4f7ba13a7ed1742e39f4e27306ad1bfca2c";
    ...
    function _assertCallData(
        ...
        assertEq(keccak256(bytes(vm.toString(callData))), keccak256(bytes(expectedCallData)));
    }
