...
contract RegressionTest is Test {
    ...
    function testRegressionCallDataMatches_OPCMUpgradeV410Template() public {
        ...
        /// @notice Expected call data generated by manually running the OPCMUpgradeV500Template at block 9475640 on sepolia.
    ...
    function testRegressionCallDataMatches_OPCMUpgradeV500Template() public {
        ...
        address[] memory allSafes = MultisigTaskTestHelper.getAllSafes(rootSafe, nestedSafe);
        (Action[] memory actions, uint256[] memory allOriginalNonces) =
            _setupAndSimulate(taskConfigFilePath, 9475640, "sepolia", multisigTask, allSafes);
    ...
    /// @notice Expected call data generated by manually running the OPCMUpgradeSuperchainConfigV500Template at block 9475640 on sepolia.
    /// Simulate from task directory (test/tasks/example/sep/029-opcm-upgrade-superchainconfig-v500/config.toml) with:
    /// SIMULATE_WITHOUT_LEDGER=1 just --dotenv-path "$(pwd)"/.env --justfile ../../../../../src/justfile simulate <council|foundation>
    function testRegressionCallDataMatches_OPCMUpgradeSuperchainConfigV500Template() public {
        string memory taskConfigFilePath = "test/tasks/example/sep/029-opcm-upgrade-superchainconfig-v500/config.toml";
        ...
        MultisigTask multisigTask = new OPCMUpgradeSuperchainConfigV500();
        address rootSafe = address(0x1Eb2fFc903729a0F03966B917003800b145F56E2);
        address nestedSafe = address(0xDEe57160aAfCF04c34C887B5962D0a69676d3C8B); // sepolia
        address[] memory allSafes = MultisigTaskTestHelper.getAllSafes(rootSafe, nestedSafe);
        (Action[] memory actions, uint256[] memory allOriginalNonces) =
        ...
        // Foundation
        expectedDataToSign[0] =
            "0x190137e1f5dd3b92a004a23589b741196c8a214629d4ea3a690ec8e41ae45c689cbbf1df2e84c63026aee625e6995a53ffcce41aff1eedb8cf02d50eec15058c9503";
        // Security Council
        expectedDataToSign[1] =
            "0x1901be081970e9fc104bd1ea27e375cd21ec7bb1eec56bfe43347c3e36c5d27b8533d0fa6c106f9a999ff99c08cec09da295712fffd5b469d719825153f611ab1db8";
        _assertDataToSignNestedMultisig(multisigTask, actions, expectedDataToSign, MULTICALL3_ADDRESS, rootSafe);
    }
