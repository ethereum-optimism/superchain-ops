...
import {OPCMUpgradeSuperchainConfigV600} from "src/template/OPCMUpgradeSuperchainConfigV600.sol";
...
contract RegressionTest is Test {
    ...
    /// @notice Expected call data generated by manually running the OPCMUpgradeV600Template at block 9560947 on sepolia.
    /// Simulate from task directory (test/tasks/example/sep/029-opcm-upgrade-v600/config.toml) with:
    /// SIMULATE_WITHOUT_LEDGER=1 just --dotenv-path "$(pwd)"/.env --justfile ../../../../../src/justfile simulate <council|foundation>
    function testRegressionCallDataMatches_OPCMUpgradeV600Template() public {
        string memory taskConfigFilePath = "test/tasks/example/sep/032-opcm-upgrade-v600/config.toml";
        string memory expectedCallData =
            "";
    ...
    function testRegressionCallDataMatches_OPCMUpgradeSuperchainConfigV410Template() public {
        ...
        /// @notice Expected call data generated by manually running the OPCMUpgradeSuperchainConfigV600Template at block 9167980 on sepolia.
    /// Simulate from task directory (test/tasks/example/sep/032-opcm-upgrade-superchainconfig-v600/config.toml) with:
    /// SIMULATE_WITHOUT_LEDGER=1 just --dotenv-path "$(pwd)"/.env --justfile ../../../../../src/justfile simulate
    function testRegressionCallDataMatches_OPCMUpgradeSuperchainConfigV600Template() public {
        string memory taskConfigFilePath = "test/tasks/example/sep/032-opcm-upgrade-superchainconfig-v600/config.toml";

        string memory expectedCallData =
            "";
        MultisigTask multisigTask = new OPCMUpgradeSuperchainConfigV600();
        address rootSafe = address(0x1Eb2fFc903729a0F03966B917003800b145F56E2);
        address nestedSafe = address(0xDEe57160aAfCF04c34C887B5962D0a69676d3C8B); // sepolia
        address[] memory allSafes = MultisigTaskTestHelper.getAllSafes(rootSafe, nestedSafe);
        (Action[] memory actions, uint256[] memory allOriginalNonces) =
