...
contract RegressionTest is Test {
    ...
    /// @notice expected call data and data to sign generated by manually running the UnpauseTemplate at block 22183268 on mainnet
    /// using script:
    /// forge script src/improvements/template/UnpauseTemplate.sol
    /// --sig "simulateRun(string)" test/tasks/mock/configs/UnpauseTemplate.toml
    /// --rpc-url mainnet
    /// --fork-block-number 22183268
    /// -vv
    function testRegressionCallDataMatches_UnpauseTemplate() public {
        string memory taskConfigFilePath = "test/tasks/mock/configs/UnpauseTemplate.toml";
        string memory expectedCallData =
            "";
        MultisigTask multisigTask = new UnpauseTemplate();
        MultisigTask.Action[] memory actions =
            _setupAndSimulateRun(taskConfigFilePath, 22183268, "mainnet", multisigTask, address(0));
        ...
        string memory expectedDataToSign =
            "0x19014e6a6554de0308f5ece8ff736beed8a1b876d16f5c27cac8e466d7de0c70389097aca7635c5f8640250994d390afb4ae1d7e2c39a598835e4bd3b825b01d0802";
