...
import {TransferL1PAO} from "src/improvements/template/TransferL1PAO.sol";
import {TransferL2PAO} from "src/improvements/template/TransferL2PAO.sol";
...
contract RegressionTest is Test {
    ...
    /// @notice Expected call data and data to sign generated by manually running the TransferL1PAO template at block 22447773 on mainnet.
    /// Simulate from task directory (test/tasks/example/eth/003-transfer-l1pao) with:
    /// SIMULATE_WITHOUT_LEDGER=1 just --dotenv-path $(pwd)/.env --justfile ../../../../../src/improvements/nested.just simulate <foundation|council>
    function testRegressionCallDataMatches_TransferL1PAO() public {
        string memory taskConfigFilePath = "test/tasks/example/eth/003-transfer-l1pao/config.toml";
        // Call data generated by manually running the TransferL1PAO template at block 22447773 on mainnet.
        string memory expectedCallData =
            "";
        MultisigTask multisigTask = new TransferL1PAO();
        ...
        // Data to sign generated by manually running the TransferL1PAO template at block 22447773 on mainnet.
        string[] memory expectedDataToSign = new string[](2);
        // Foundation
        expectedDataToSign[0] =
            "0x1901a4a9c312badf3fcaa05eafe5dc9bee8bd9316c78ee8b0bebe3115bb21b73267254a7b5c5ec33963b02cbed72d8cb1506787ef0db93ff2325b7551b08dd5c505a";
        // Security council
        expectedDataToSign[1] =
            "0x1901df53d510b56e539b90b369ef08fce3631020fbf921e3136ea5f8747c20bce9671d287ec576f603e233553fb2ff1080c2ab2db55a2d8c692cf66670f9a454e8c7";
        _assertDataToSignNestedMultisig(multisigTask, actions, expectedDataToSign);
    }

    /// @notice Expected call data and data to sign generated by manually running the TransferL2PAO template at block 22447773 on mainnet.
    /// Simulate from task directory (test/tasks/example/eth/008-transfer-l2pao) with:
    /// SIMULATE_WITHOUT_LEDGER=1 just --dotenv-path $(pwd)/.env --justfile ../../../../../src/improvements/nested.just simulate <foundation|council>
    function testRegressionCallDataMatches_TransferL2PAO() public {
        string memory taskConfigFilePath = "test/tasks/example/eth/008-transfer-l2pao/config.toml";
        // Call data generated by manually running the TransferL2PAO template at block 22447773 on mainnet.
        string memory expectedCallData =
            "";
        MultisigTask multisigTask = new TransferL2PAO();
        address foundationChildMultisig = 0x847B5c174615B1B7fDF770882256e2D3E95b9D92;
        MultisigTask.Action[] memory actions =
            _setupAndSimulateRun(taskConfigFilePath, 22447773, "mainnet", multisigTask, foundationChildMultisig);
        ...
        // Data to sign generated by manually running the TransferL2PAO template at block 22447773 on mainnet.
        string[] memory expectedDataToSign = new string[](2);
        // Foundation
        expectedDataToSign[0] =
            "0x1901a4a9c312badf3fcaa05eafe5dc9bee8bd9316c78ee8b0bebe3115bb21b7326721ee4caede03d993eb712b4d820dad32c43568663697e69f568b26423955415ac";
        // Security council
        expectedDataToSign[1] =
            "0x1901df53d510b56e539b90b369ef08fce3631020fbf921e3136ea5f8747c20bce967437a26f4da52b396f8e84e8b2666f6805a4a6f1fcfa86138c806e34407541549";
        _assertDataToSignNestedMultisig(multisigTask, actions, expectedDataToSign);
    }
    ...
    function testRegressionCallDataMatches_TransferOwners() public {
        ...
        string memory expectedCallData =
            "";
        ...
        // Chain governor
        expectedDataToSign[0] =
            "0x19014f0b6efb6c01fa7e127a0ff87beefbeb53e056d30d3216c5ac70371b909ca66d28282efbe4481e563aba89a4b48d42d0b334c58b7b5c369141eb099bb0d89635";
        // Foundation
        expectedDataToSign[1] =
            "0x1901a4a9c312badf3fcaa05eafe5dc9bee8bd9316c78ee8b0bebe3115bb21b732672d5cb3fd14bab6513273d9edd33d193a7defd1b39c39150f0168bba85cbf12f71";
        // Security council
        expectedDataToSign[2] =
            "0x1901df53d510b56e539b90b369ef08fce3631020fbf921e3136ea5f8747c20bce967c94ccee5ed95a49a841020122239275ebdc45a9593e3de2b64ecaeab4f6f112a";
        _assertDataToSignNestedMultisig(multisigTask, actions, expectedDataToSign);
    }
