...
contract RegressionTest is Test {
    ...
    /// @notice Expected call data generated by manually running the OPCMUpgradeV600Template at block 9873990 on sepolia.
    ...
    function testRegressionCallDataMatches_OPCMUpgradeV600Template() public {
        ...
        address[] memory allSafes = MultisigTaskTestHelper.getAllSafes(rootSafe, nestedSafe);
        (Action[] memory actions, uint256[] memory allOriginalNonces) =
            _setupAndSimulate(taskConfigFilePath, 9873990, "sepolia", multisigTask, allSafes);
        ...
        // Betant EOA
        expectedDataToSign[0] =
            "0x190107e03428d7125835eca12b6dd1a02903029b456da3a091ecd66fda859fbce61e43969f2c94cd0b41ae1b539b1a311f5442c17610887940ba211499a9b169e342";
        _assertDataToSignNestedMultisig(multisigTask, actions, expectedDataToSign, MULTICALL3_ADDRESS, rootSafe);
    }
