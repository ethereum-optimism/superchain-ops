...
contract RegressionTest is Test {
    ...
    /// @notice Expected call data and data to sign generated by manually running the RevShareContractsUpgrader template at block 9622994 on Sepolia.
    /// Simulate from task directory (test/tasks/example/sep/030-revshare-upgrade-and-setup) with:
    /// SIMULATE_WITHOUT_LEDGER=1 just --dotenv-path $(pwd)/.env --justfile ../../../../../src/improvements/single.just simulate <foundation|council>
    function testRegressionCallDataMatches_RevShareContractsUpgrader() public {
        string memory taskConfigFilePath = "test/tasks/example/sep/030-revshare-upgrade-and-setup/config.toml";
        string memory expectedCallData =
            "";
        ...
        (Action[] memory actions, uint256[] memory allOriginalNonces) =
            _setupAndSimulate(taskConfigFilePath, 9622994, "sepolia", multisigTask, allSafes);
        ...
        // Foundation
        expectedDataToSign[0] =
            "0x190137e1f5dd3b92a004a23589b741196c8a214629d4ea3a690ec8e41ae45c689cbb6474d19f0ca26aea28a7eac7ae0c70e5a38e67c6a3b27d12f55f7f57fa5ee72d";
        // Security Council
        expectedDataToSign[1] =
            "0x1901be081970e9fc104bd1ea27e375cd21ec7bb1eec56bfe43347c3e36c5d27b85336e39376a29692f08ece1f12583145b47c6d58556049f610bdb3d19439f7b7c58";
