...
import {OPCMUpgradePrestateV300} from "src/improvements/template/OPCMUpgradePrestateV300.sol";
...
contract RegressionTest is Test {
    ...
    /// @notice Expected call data and data to sign generated by manually running the OPCMUpgradePrestateV300 template at block 8098229 on sepolia
    /// Simulate from task directory (test/tasks/example/sep/007-opcm-upgrade-prestate-v300) with:
    /// SIMULATE_WITHOUT_LEDGER=1 just --dotenv-path $(pwd)/.env --justfile ../../../../../src/improvements/nested.just simulate <foundation|council>
    function testRegressionCallDataMatches_OPCMUpgradePrestateV300() public {
        string memory taskConfigFilePath = "test/tasks/example/sep/007-opcm-upgrade-prestate-v300/config.toml";
        // Call data generated by manually running the OPCMUpgradePrestateV300 template at block 8098229 on sepolia.
        string memory expectedCallData =
        ...
        MultisigTask multisigTask = new OPCMUpgradePrestateV300();
        ...
        // Data to sign generated by manually running the OPCMUpgradePrestateV300 template at block 8098229 on sepolia.
        string[] memory expectedDataToSign = new string[](2);
        // Foundation
        expectedDataToSign[0] =
