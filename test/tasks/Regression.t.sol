...
contract RegressionTest is Test {
    ...
    /// forge script test/template/GasConfigTemplate.sol --sig "simulateRun(string)" test/tasks/mock/configs/SingleMultisigGasConfigTemplate.toml --rpc-url mainnet --fork-block-number 21724199 -vv
    function testRegressionCallDataMatches_SingleMultisigGasConfigTemplate() public {
        ...
        (Action[] memory actions, uint256 rootSafeNonce) =
            _setupAndSimulateRun(taskConfigFilePath, 21724199, "mainnet", multisigTask, rootSafe, address(0));
        ...
        string memory dataToSign = vm.toString(
            multisigTask.getEncodedTransactionData(
                multisigTask.parentMultisig(), multisigTask.getMulticall3Calldata(actions), 0, rootSafeNonce
            )
        );
        ...
        _assertDataToSignSingleMultisig(multisigTask, actions, expectedDataToSign, rootSafeNonce);
    }
    ...
    /// forge script test/template/DisputeGameUpgradeTemplate.sol --sig "simulateRun(string)" test/tasks/mock/configs/NestedMultisigDisputeGameUpgradeTemplate.toml --rpc-url mainnet --fork-block-number 21724199 -vv
    function testRegressionCallDataMatches_NestedMultisigDisputeGameUpgradeTemplate() public {
        ...
        (Action[] memory actions,) = _setupAndSimulateRun(
            taskConfigFilePath, 21724199, "mainnet", multisigTask, rootSafe, securityCouncilChildMultisig
        );
    ...
    /// @notice expected call data and data to sign generated by manually running the GasConfigTemplate at block 21724199 on mainnet using script:
    /// forge script test/template/GasConfigTemplate.sol --sig "simulateRun(string)" test/tasks/mock/configs/OPMainnetGasConfigTemplate.toml --rpc-url mainnet --fork-block-number 21724199 -vv
    ...
    /// forge script src/improvements/template/SetRespectedGameTypeTemplate.sol --sig "simulateRun(string)" test/tasks/mock/configs/SetRespectedGameTypeTemplate.toml --rpc-url mainnet --fork-block-number 21724199 -vv
    ...
    /// forge script src/improvements/template/UpdateRetirementTimestampTemplate.sol --sig "simulateRun(string)" test/tasks/mock/configs/UpdateRetirementTimestampTemplate.toml --rpc-url mainnet --fork-block-number 22183268 -vv
    function testRegressionCallDataMatches_UpdateRetirementTimestampTemplate() public {
        ...
        address rootSafe = address(0x9BA6e03D8B90dE867373Db8cF1A58d2F7F006b3A); // FoundationOperationSafe
        (Action[] memory actions, uint256 rootSafeNonce) =
            _setupAndSimulateRun(taskConfigFilePath, 22183268, "mainnet", multisigTask, rootSafe, address(0));
    ...
    /// forge script src/improvements/template/EnableDeputyPauseModuleTemplate.sol --sig "simulateRun(string)" test/tasks/mock/configs/EnableDeputyPauseModuleTemplate.toml --rpc-url sepolia --fork-block-number 7745524 -vv
    function testRegressionCallDataMatches_EnableDeputyPauseModuleTemplate() public {
        ...
        (Action[] memory actions, uint256 rootSafeNonce) =
            _setupAndSimulateRun(taskConfigFilePath, 7745524, "sepolia", multisigTask, rootSafe, address(0));
    ...
    function testRegressionCallDataMatches_OPCMUpgradeV200() public {
        ...
        (Action[] memory actions,) = _setupAndSimulateRun(
            taskConfigFilePath, 7826712, "sepolia", multisigTask, rootSafe, foundationChildMultisig
        );
    ...
    function testRegressionCallDataMatches_OPCMUpgradeV300() public {
        ...
        address foundationChildMultisig = 0xDEe57160aAfCF04c34C887B5962D0a69676d3C8B; // sepolia
        (Action[] memory actions,) = _setupAndSimulateRun(
            taskConfigFilePath, 8044263, "sepolia", multisigTask, rootSafe, foundationChildMultisig
        );
    ...
    function testRegressionCallDataMatches_OPCMUpgradeV400() public {
        ...
        address foundationChildMultisig = 0xDEe57160aAfCF04c34C887B5962D0a69676d3C8B; // sepolia
        (Action[] memory actions,) = _setupAndSimulateRun(
            taskConfigFilePath, 8469737, "sepolia", multisigTask, rootSafe, foundationChildMultisig
        );
    ...
    function testRegressionCallDataMatches_SystemConfigGasParams() public {
        ...
        (Action[] memory actions, uint256 rootSafeNonce) =
            _setupAndSimulateRun(taskConfigFilePath, 22283936, "mainnet", multisigTask, rootSafe, address(0));
    ...
    /// forge script src/improvements/template/DelayedWETHOwnershipTemplate.sol --sig "simulateRun(string)" test/tasks/mock/configs/DelayedWETHOwnershipTemplate.toml --rpc-url mainnet --fork-block-number 22183268 -vv
    ...
    /// forge script src/improvements/template/FinanceTemplate.sol --sig "simulateRun(string)" test/tasks/mock/configs/TestFinanceTemplate.toml --rpc-url sepolia --fork-block-number 7880546 -vv
    function testRegressionCallDataMatches_FinanceTemplate() public {
        ...
        (Action[] memory actions, uint256 rootSafeNonce) =
            _setupAndSimulateRun(taskConfigFilePath, 7880546, "sepolia", multisigTask, rootSafe, address(0));
    ...
    function testRegressionCallDataMatches_OPCMUpdatePrestateV300() public {
        ...
        (Action[] memory actions,) = _setupAndSimulateRun(
            taskConfigFilePath, 8098229, "sepolia", multisigTask, rootSafe, foundationChildMultisig
        );
    ...
    function testRegressionCallDataMatches_TransferL2PAOFromL1() public {
        ...
        (Action[] memory actions,) = _setupAndSimulateRun(
            taskConfigFilePath, 22447773, "mainnet", multisigTask, rootSafe, foundationChildMultisig
        );
    ...
    function testRegressionCallDataMatches_DisableModule() public {
        ...
        (Action[] memory actions,) =
            _setupAndSimulateRun(taskConfigFilePath, 8326814, "sepolia", multisigTask, rootSafe, nestedSafe);
    ...
    function testRegressionCallDataMatches_TransferOwners() public {
        ...
        address foundationChildMultisig = 0x847B5c174615B1B7fDF770882256e2D3E95b9D92;
        (Action[] memory actions,) = _setupAndSimulateRun(
            taskConfigFilePath, 22469206, "mainnet", multisigTask, rootSafe, foundationChildMultisig
        );
    ...
    function testRegressionCallDataMatches_GnosisSafeApproveHash() public {
        ...
        (Action[] memory actions,) = _setupAndSimulateRun(
            taskConfigFilePath, 8384642, "sepolia", multisigTask, rootSafe, 0x6AF0674791925f767060Dd52f7fB20984E8639d8
        );
    ...
    ) internal returns (Action[] memory actions, uint256 rootSafeNonce) {
        vm.createSelectFork(network, blockNumber);
        rootSafeNonce = IGnosisSafe(rootSafe).nonce();
    ...
    function _assertDataToSignSingleMultisig(
        ...
        string memory dataToSign = vm.toString(
            multisigTask.getEncodedTransactionData(
                multisigTask.parentMultisig(), multisigTask.getMulticall3Calldata(actions), 0, originalNonce
            )
        );
        assertEq(keccak256(bytes(dataToSign)), keccak256(bytes(expectedDataToSign)));
    }
    ...
    function _assertDataToSignNestedMultisig(
        ...
        for (uint256 i = 0; i < owners.length; i++) {
            ...
            uint256 nestedSafeNonce = IGnosisSafe(owners[i]).nonce();
            string memory dataToSign = vm.toString(
                multisigTask.getEncodedTransactionData(
                    owners[i], multisigTask.generateApproveMulticallData(actions), 0, nestedSafeNonce
                )
            );
