...
import {EnableDeputyPauseModule} from "src/improvements/template/EnableDeputyPauseModule.sol";
...
contract RegressionTest is Test {
    ...
    /// @notice expected call data and data to sign generated by manually running the EnableDeputyPauseModule at block 7745524 on sepolia
    /// using script:
    /// forge script src/improvements/template/EnableDeputyPauseModule.sol
    /// --sig "simulateRun(string)" test/tasks/mock/configs/EnableDeputyPauseModule.toml
    /// --rpc-url sepolia
    /// --fork-block-number 7745524
    /// -vv
    function testRegressionCallDataMatches_EnableDeputyPauseModule() public {
        string memory taskConfigFilePath = "test/tasks/mock/configs/EnableDeputyPauseModule.toml";
        string memory expectedCallData =
        ...
        MultisigTask multisigTask = new EnableDeputyPauseModule();
        MultisigTask.Action[] memory actions =
