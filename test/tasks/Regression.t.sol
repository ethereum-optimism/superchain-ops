...
contract RegressionTest is Test {
    ...
    /// @notice Expected call data and data to sign generated by manually running the OPCMUpgradeV300 template at block 7972618 on sepolia
    /// Simulate from task directory (test/tasks/example/sep/003-opcm-upgrade-v300) with:
    ...
    function testRegressionCallDataMatches_OPCMUpgradeV300() public {
        string memory taskConfigFilePath = "test/tasks/example/sep/003-opcm-upgrade-v300/config.toml";
        ...
        address foundationChildMultisig = 0xDEe57160aAfCF04c34C887B5962D0a69676d3C8B; // sepolia
        MultisigTask.Action[] memory actions =
            _setupAndSimulateRun(taskConfigFilePath, 7972618, "sepolia", multisigTask, foundationChildMultisig);

        console.log("Assert calldata matches");
        _assertCallData(multisigTask, actions, expectedCallData);

        // Data to sign generated by manually running the OPCMUpgradeV300 template at block 7972618 on sepolia
        // for each child multisig
        console.log("Check \"data to sign\"");
        string[] memory expectedDataToSign = new string[](2);
    ...
    function _assertDataToSignNestedMultisig(
        ...
        for (uint256 i = 0; i < owners.length; i++) {
            ...
            console.log("Check data to sign for owner", i, ":", LibString.toHexString(owners[i]));
