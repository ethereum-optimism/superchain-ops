...
import {OPCMUpgrade_v300} from "src/improvements/template/OPCMUpgrade_v300.sol";
import {OPCMUpgrade_v400} from "src/improvements/template/OPCMUpgrade_v400.sol";
import {OPCMUpdatePrestate_v300} from "src/improvements/template/OPCMUpdatePrestate_v300.sol";
...
contract RegressionTest is Test {
    ...
    function testRegressionCallDataMatches_OPCMUpgradeV200() public {
        ...
        MultisigTask multisigTask = new OPCMUpgrade_v200();
    ...
    function testRegressionCallDataMatches_OPCMUpgradeV300() public {
        ...
        MultisigTask multisigTask = new OPCMUpgrade_v300();
        address rootSafe = address(0x1Eb2fFc903729a0F03966B917003800b145F56E2);
        address foundationChildMultisig = 0xDEe57160aAfCF04c34C887B5962D0a69676d3C8B; // sepolia
        address[] memory allSafes = MultisigTaskTestHelper.getAllSafes(rootSafe, foundationChildMultisig);
    ...
    function testRegressionCallDataMatches_OPCMUpgradeV400() public {
        ...
        MultisigTask multisigTask = new OPCMUpgrade_v400();
        address rootSafe = address(0x1Eb2fFc903729a0F03966B917003800b145F56E2);
        address foundationChildMultisig = 0xDEe57160aAfCF04c34C887B5962D0a69676d3C8B; // sepolia
        address[] memory allSafes = MultisigTaskTestHelper.getAllSafes(rootSafe, foundationChildMultisig);
    ...
    /// @notice Expected call data and data to sign generated by manually running the OPCMUpdatePrestate_v300 template at block 8098229 on sepolia
    /// Simulate from task directory (test/tasks/example/sep/008-opcm-upgrade-prestate-v300) with:
    /// SIMULATE_WITHOUT_LEDGER=1 just --dotenv-path $(pwd)/.env --justfile ../../../../../src/improvements/nested.just simulate <foundation|council>
    function testRegressionCallDataMatches_OPCMUpdatePrestate_v300() public {
        string memory taskConfigFilePath = "test/tasks/example/sep/008-opcm-upgrade-prestate-v300/config.toml";
        // Call data generated by manually running the OPCMUpdatePrestate_v300 template at block 8098229 on sepolia.
        string memory expectedCallData =
        ...
        MultisigTask multisigTask = new OPCMUpdatePrestate_v300();
        address rootSafe = address(0x1Eb2fFc903729a0F03966B917003800b145F56E2);
        ...
        // Data to sign generated by manually running the OPCMUpdatePrestate_v300 template at block 8098229 on sepolia.
        string[] memory expectedDataToSign = new string[](2);
        // Foundation
        expectedDataToSign[0] =
