...
contract RegressionTest is Test {
    ...
    /// Simulate from task directory (test/tasks/example/eth/014-revenue-share-upgrade/config.toml) with:
    ...
    function testRegressionCallDataMatches_RevenueShareV100UpgradePath() public {
        string memory taskConfigFilePath = "test/tasks/example/eth/014-revenue-share-upgrade/config.toml";
        string memory expectedCallData =
