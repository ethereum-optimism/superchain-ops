...
contract RegressionTest is Test {
    ...
    /// @notice Expected call data generated by manually running the OPCMUpgradeV500Template at block 9481824 on sepolia.
    ...
    function testRegressionCallDataMatches_OPCMUpgradeV500Template() public {
        ...
        string memory expectedCallData =
            "";
        MultisigTask multisigTask = new OPCMUpgradeV500();
        address rootSafe = address(0x1Eb2fFc903729a0F03966B917003800b145F56E2);
        address nestedSafe = address(0xDEe57160aAfCF04c34C887B5962D0a69676d3C8B); // sepolia
        address[] memory allSafes = MultisigTaskTestHelper.getAllSafes(rootSafe, nestedSafe);
        (Action[] memory actions, uint256[] memory allOriginalNonces) =
            _setupAndSimulate(taskConfigFilePath, 9481824, "sepolia", multisigTask, allSafes);
        ...
        // Foundation
        expectedDataToSign[0] =
            "0x190137e1f5dd3b92a004a23589b741196c8a214629d4ea3a690ec8e41ae45c689cbbc801e6c5bf7ad496258cc3db6d557b7385cda9876e2c5e2795b125d81430d89b";
        // Security Council
        expectedDataToSign[1] =
            "0x1901be081970e9fc104bd1ea27e375cd21ec7bb1eec56bfe43347c3e36c5d27b85331bb4910ddcc3ff83ace08527c8cb7ca2fcb872df37abc11a857c79a6c24adeca";
        _assertDataToSignNestedMultisig(multisigTask, actions, expectedDataToSign, MULTICALL3_ADDRESS, rootSafe);
    }
