...
import {OPCMUpdatePrestateV600} from "src/template/OPCMUpdatePrestateV600.sol";
...
contract RegressionTest is Test {
    ...
    /// @notice Expected call data generated by manually running the OPCMUpdatePrestateV600Template at block 10022609 on sepolia.
    /// Simulate from task directory (test/tasks/example/sep/034-opcm-update-prestate-v600/config.toml) with:
    /// SIMULATE_WITHOUT_LEDGER=1 just --dotenv-path "$(pwd)"/.env --justfile ../../../../../src/justfile simulate
    function testRegressionCallDataMatches_OPCMUpdatePrestateV600Template() public {
        string memory taskConfigFilePath = "test/tasks/example/sep/034-opcm-update-prestate-v600/config.toml";
        // Call data generated by manually running the template on sepolia
        string memory expectedCallData =
            "";
        ...
        allSafes[0] = rootSafe;
        (Action[] memory actions, uint256[] memory allOriginalNonces) =
            _setupAndSimulate(taskConfigFilePath, 10022609, "sepolia", multisigTask, allSafes);
        bytes memory rootSafeCalldata =
            _assertCallDataMatches(multisigTask, actions, allSafes, allOriginalNonces, expectedCallData);

        // Data to sign generated by manually running the template on sepolia at block 10022609
        uint256 rootSafeNonce = allOriginalNonces[allOriginalNonces.length - 1];
        string memory expectedDataToSign =
        ...
        _assertDataToSignSingleMultisig(rootSafe, rootSafeCalldata, expectedDataToSign, rootSafeNonce, multicallAddress);
    }
