...
contract RegressionTest is Test {
    ...
    /// Simulate from task directory (test/tasks/example/sep/039-set-dispute-game-args/config.toml) with:
    /// SIMULATE_WITHOUT_LEDGER=1 just --dotenv-path $(pwd)/.env --justfile ../../../../../src/justfile simulate
    function testRegressionCallDataMatches_SetDisputeGameArgs() public {
        string memory taskConfigFilePath = "test/tasks/example/sep/039-set-dispute-game-args/config.toml";
        string memory expectedCallData =
