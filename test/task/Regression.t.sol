...
contract RegressionTest is Test {
    function testRegressionCallDataMatchesTask00() public {
        string memory taskConfigFilePath = "test/task/mock/example/task-00/config.toml";
    ...
    function testRegressionCallDataMatchesTask01() public {
        string memory taskConfigFilePath = "test/task/mock/example/task-01/config.toml";
        string memory expectedCallData =
    ...
    function testRegressionCallDataMatchesTask02() public {
        string memory taskConfigFilePath = "test/task/mock/example/task-02/config.toml";
        string memory expectedCallData =
    ...
    function testRegressionCallDataMatchesTask03() public {
        string memory taskConfigFilePath = "test/task/mock/example/task-03/config.toml";
        string memory expectedCallData =
