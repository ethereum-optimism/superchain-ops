...
contract SignFromJson is OriginalSignFromJson {
    ...
    address constant l2OutputOracleProposer = 0xe9e08A478e3a773c1B5D59014A0FDb901e6d1d69; // cast call $L2OO "PROPOSER()(address)"
    ...
    address constant batchSenderAddress = 0x4e6BD53883107B063c502dDd49F9600Dc51b3DDc; // In registry genesis-system-configs
    address constant p2pSequencerAddress = 0x93A14E6894eEB4FF6a373E1Ad4f498c3a207afe4; // cast call $SystemConfig "unsafeBlockSigner()(address)"
    address constant batchInboxAddress = 0xcDDaE6148dA1E003C230E4527f9baEdc8a204e7E; // In registry yaml.
    ...
    // Other data we use.
    uint256 systemConfigStartBlock = 3778414; // This was an input when generating input.json
    AddressManager addressManager = AddressManager(0x83D45725d6562d8CD717673D6bb4c67C07dC1905);
