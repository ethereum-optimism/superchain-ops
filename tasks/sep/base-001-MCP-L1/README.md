# Base Sepolia MCP L1 Upgrade

Status: [EXECUTED](https://sepolia.etherscan.io/tx/0xdd0716a31a2b71f0f4162f474bbfb3873eb570e0395d42f3a945b65e35562dbf)

## Objective

This is the playbook for executing Upgrade #6, Multi-Chain Prep (MCP) L1, on Base Sepolia (chain ID 84532).
...
When simulating, ensure the logs say `Using script Using script /your/path/to/superchain-ops/tasks/sep/base-001-MCP-L1/SignFromJson.s.sol`.
