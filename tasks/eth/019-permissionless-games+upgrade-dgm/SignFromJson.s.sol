...
contract SignFromJson is OriginalSignFromJson {
    ...
    function checkRespectedGameType() internal view {
        ...
        require(portal.respectedGameType().raw() == GameTypes.CANNON.raw(), "Respected game type is not CANNON");
    }
    ...
    function checkDeputyGuardianModule() internal view {
        ...
        require(
            ModuleManager(expectedGuardian).isModuleEnabled(expectedDeputyGuardianModule),
            "checkDeputyGuardianModule-500"
        );
    }
}
