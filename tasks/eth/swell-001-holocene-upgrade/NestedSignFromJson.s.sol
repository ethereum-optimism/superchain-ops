...
contract NestedSignFromJson is OriginalNestedSignFromJson {
    ...
    function setUp() public {
        ...
        // _precheckDisputeGameImplementation(GameType.wrap(0), 0x2DabFf87A9a634f6c769b983aFBbF4D856aDD0bF);
        _precheckDisputeGameImplementation(GameType.wrap(1), 0x1380Cc0E11Bfe6b5b399D97995a6B3D158Ed61a6);
    ...
    function _postCheck(Vm.AccountAccess[] memory accesses, Simulation.Payload memory) internal view override {
        ...
        _checkDisputeGameImplementation(GameType.wrap(0), 0x2DabFf87A9a634f6c769b983aFBbF4D856aDD0bF);
        _checkDisputeGameImplementation(GameType.wrap(1), 0x1380Cc0E11Bfe6b5b399D97995a6B3D158Ed61a6);
