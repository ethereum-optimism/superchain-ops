...
The objective of this task is to upgrade Zora Mainnet to Permissioned Fault Proofs at contracts
...
```sh
Using script /your/path/to/superchain-ops/tasks/eth/zora-002-fp-upgrade/NestedSignFromJson.s.sol
```
...
```sh
Using script Using script /your/path/to/superchain-ops/tasks/eth/zora-002-fp-upgrade/NestedSignFromJson.s.sol
```
